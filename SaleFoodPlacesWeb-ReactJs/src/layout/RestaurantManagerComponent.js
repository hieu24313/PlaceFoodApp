...
const RestaurantManagerConpoment = () => {
    ...
    const receivedValue = cookie.load("restaurant");
    ...
    return <>
        <ul className="dasboard_ul" >
            ...
            <hr />
            <li className="dasboard_ul_lastchild"><Link to="" className="btn">Danh Mục</Link></li>
            <hr />
            ...
            <hr />
            <li className="dasboard_ul_lastchild"><Link to="" className="btn">Combo</Link></li>
            <hr />
